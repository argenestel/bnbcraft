    ...
    <div className="flex flex-col h-screen">
      ...
      <title>Zeek Craft</title>
        ...
        <meta
          ...
          content='Zeek Craft  is a Fully on chain UGC game you can create new recipes by mixing recipes with recipes.'
        />
        ...
        <meta name='twitter:title' content='Zeek Craft - Generate infinite recipe and earn points' />
        <meta
        ...
        <meta
          name='twitter:image'
          content='https://zeek.vercel.app/ogp.png'
        />
      </Head>
